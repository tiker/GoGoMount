if GetLocale() == "esES" then
	...
	GoGo_Variables.Localize = --@localization(locale="esES", format="lua_table", handle-unlocalized="english", handle-subnamespaces="subtable", namespace="GoGo_Variables/Localize")@
end --if
