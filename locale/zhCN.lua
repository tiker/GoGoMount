if GetLocale() == "zhCN" then
	...
	GoGo_Variables.Localize = --@localization(locale="zhCN", format="lua_table", handle-unlocalized="english", handle-subnamespaces="subtable", namespace="GoGo_Variables/Localize")@
end --if
