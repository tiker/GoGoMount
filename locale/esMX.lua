if GetLocale() == "esMX" then
	...
	GoGo_Variables.Localize = --@localization(locale="esMX", format="lua_table", handle-unlocalized="english", handle-subnamespaces="subtable", namespace="GoGo_Variables/Localize")@
end --if
