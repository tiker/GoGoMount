if GetLocale() == "ruRU" then
	...
	GoGo_Variables.Localize = --@localization(locale="ruRU", format="lua_table", handle-unlocalized="english", handle-subnamespaces="subtable", namespace="GoGo_Variables/Localize")@
end --if
